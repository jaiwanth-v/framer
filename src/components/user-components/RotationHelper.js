...
var setHeightAndDeltaH = function setHeightAndDeltaH(
  height,
  deltaH,
  minHeight
) {
...
var getNewStyle = function getNewStyle(
  type,
  rect,
  deltaW,
  deltaH,
  ...
  (function (_PureComponent) {
    ...
    function Rect() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(Rect)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
        ...
        value: function render() {
          ...
          return React.createElement(
            ...
            direction.map(function (d) {
              var cursor = "".concat(
                getCursor(rotateAngle + parentRotateAngle, d),
                "-resize"
              );
...
var ResizableRect =
  ...
  (function (_Component) {
    ...
    function ResizableRect() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(ResizableRect)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
      ...
      _defineProperty(
        _assertThisInitialized(_assertThisInitialized(_this)),
        "handleResize",
        function (length, alpha, rect, type, isShiftKey) {
